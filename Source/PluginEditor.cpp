...
ResponseCurveComponent::ResponseCurveComponent(Vsttutorialv2AudioProcessor& p) : audioProcessor(p)
{
...
//==============================================================================
Vsttutorialv2AudioProcessorEditor::Vsttutorialv2AudioProcessorEditor (Vsttutorialv2AudioProcessor& p)
    ...
    lowCutSlopeSlider(*audioProcessor.apvts.getParameter("HighCutSlope"),  "dB/Oct"),
    highCutSlopeSlider(*audioProcessor.apvts.getParameter("LowCutSlope"),  "dB/Oct"),
    ...
    lowCutSlopeSliderAttachment(audioProcessor.apvts, "HighCutSlope", lowCutSlopeSlider),
    highCutSlopeSliderAttachment(audioProcessor.apvts, "LowCutSlope", highCutSlopeSlider)
...
//==============================================================================
void Vsttutorialv2AudioProcessorEditor::paint (juce::Graphics& g)
{
    using namespace juce;
    // (Our component is opaque, so we must completely fill the background with a solid colour)
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
...
void Vsttutorialv2AudioProcessorEditor::resized()
{
...
std::vector<juce::Component*> Vsttutorialv2AudioProcessorEditor::getComps()
{
...
void RotarySliderWithLabels::paint(juce::Graphics& g)
{
    ...
    auto sliderrBounds = getSliderBounds();


    getLookAndFeel().drawRotarySlider(g,
        sliderrBounds.getX(),
        sliderrBounds.getY(),
        sliderrBounds.getWidth(),
        sliderrBounds.getHeight(),
...
juce::String RotarySliderWithLabels::getDisplaySetting() const
{
...
void LookAndFeel::drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPosProportional, float rotaryStartAngle, float rotaryEndAngle, juce::Slider& slider)
{
    ...
    if (auto* rswl = dynamic_cast<RotarySliderWithLabels*>(&slider))
    {
        ...
        auto text = rswl->getDisplaySetting();
