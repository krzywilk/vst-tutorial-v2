...
/**
*/
class Vsttutorialv2AudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    Vsttutorialv2AudioProcessor();
    ~Vsttutorialv2AudioProcessor() override;
    ...
    static juce::AudioProcessorValueTreeState::ParameterLayout createParaneterLayout();
       

    juce::AudioProcessorValueTreeState apvts{ *this,nullptr,"Params",  createParaneterLayout() }; 
